...
public class MFT_Colors {
	 // All 128 colors from the Twister source code
	  ...
	  public static int getClosestMFT_Color(float red, float green, float blue) 
	  {
		  int colorIndex = 0;
		  Color color = Color.fromRGB(red, green, blue);
	    
	      // Find if an exact match exists and use this MIDI value if it does
	      int existingIndex = ALL.indexOf(color);
	       ...
	       */
	      if (saturation > 0.0) { //it's ligther than black
